...
| QA-10 | Application submission | Student applies to job and app stores result. | Not complete | [Bugs and limitations](BUGS_AND_LIMITATIONS.md) |
...
| Password security | Plain-text password handling remains a known limitation. |
