...
| What is incomplete? | Full student application submission, password hashing, full accessibility audit, and stronger exact PR/issue evidence. |
...
| Why is application submission incomplete? | We prioritized the marketplace skeleton and employer job posting. Next step is an `applications` table and servlet. |
